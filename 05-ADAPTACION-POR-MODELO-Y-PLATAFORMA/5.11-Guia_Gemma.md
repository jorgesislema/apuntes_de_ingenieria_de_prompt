...
Proporciona un análisis que permita una toma de decisiones informada y una ejecución exitosa de transacciones.
```
...
Actúa como un representante de servicio al cliente experto con conocimiento profundo del producto y habilidades excepcionales de resolución de problemas.
