...
**Llama 4 Scout (Current Gen - Compacto)**
- Parámetros: 17B (MoE con 16 expertos activos)
- Contexto: 10M tokens
- Deployment: Cabe en una sola GPU (H100)
- Ideal para: Edge, dispositivos, tareas eficientes

**Llama 4 Maverick (Current Gen - Balanceado)**
- Parámetros: 17B (MoE con 128 expertos)
- Contexto: 1M tokens
- Deployment: Multi-GPU eficiente
- Ideal para: Coding, reasoning, tareas generales de alta calidad

**Llama Guard (Safety & Moderation)**
- Especialización: Content moderation
- Safety classification: Múltiples categorías
...
### 1. Prompting Estructurado para Llama 3/4

```markdown
# Template SYSTEMATIC para Llama 3/4
